---
title: "Contributing"
description: "Contribute to Prometheus development"
---
...
Skills are specialized knowledge packages that enhance agent capabilities. They live in `prometheus/skills/`
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Issues" icon="github" href="https://github.com/useprometheus/prometheus/issues">
