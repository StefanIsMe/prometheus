...
Skills are structured knowledge packages that give Prometheus agents deep expertise in specific vulnerability types, technologies, and testing methodologies.
...
When Prometheus spawns an agent for a specific task, it selects up to 5 relevant skills based on the context:
