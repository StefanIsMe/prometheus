...
Skip the setup. Run Prometheus in the cloud at [app.prometheus.ai](https://app.prometheus.ai).
...
1. Sign up at [app.prometheus.ai](https://app.prometheus.ai)
2. Connect your repository or enter a target URL
3. Launch your first scan

<Card title="Try Prometheus Cloud" icon="rocket" href="https://app.prometheus.ai">
