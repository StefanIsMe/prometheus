---
title: "Agent Tools"
description: "How Prometheus agents interact with targets"
---

Prometheus agents use specialized tools to test your applications like a real penetration tester would.
