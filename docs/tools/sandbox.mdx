---
title: "Sandbox Tools"
description: "Pre-installed security tools in the Prometheus container"
---

Prometheus runs inside a Kali Linux-based Docker container with a comprehensive set of security tools pre-installed. The agent can use any of these tools through the [terminal](/tools/terminal).
