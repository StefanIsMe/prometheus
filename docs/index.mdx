...
Prometheus agents come equipped with a comprehensive toolkit:
...
Prometheus uses a graph of specialized agents for comprehensive security testing:
...
<CardGroup cols={2}>
  <Card title="GitHub" icon="github" href="https://github.com/StefanIsMe/Prometheus">
