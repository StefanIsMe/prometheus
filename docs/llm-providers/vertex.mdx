...
description: "Configure Prometheus with Gemini models via Google Cloud"
---

## Installation

Vertex AI requires the Google Cloud dependency. Install Prometheus with the vertex extra:

```bash
pipx install "prometheus-agent[vertex]"
```

## Setup

```bash
export PROMETHEUS_LLM="vertex_ai/gemini-3-pro-preview"
```
