---
title: "Overview"
description: "Configure your AI model for Prometheus"
---

Prometheus uses [LiteLLM](https://docs.litellm.ai/docs/providers) for model compatibility, supporting 100+ LLM providers.
...
```bash
export PROMETHEUS_LLM="ollama/llama4"
