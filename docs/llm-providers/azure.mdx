---
title: "Azure OpenAI"
description: "Configure Prometheus with OpenAI models via Azure"
---

## Setup

```bash
export PROMETHEUS_LLM="azure/your-gpt5-deployment"
...
|----------|-------------|
| `PROMETHEUS_LLM` | `azure/<your-deployment-name>` |
...
```bash
export PROMETHEUS_LLM="azure/gpt-5.4-deployment"
