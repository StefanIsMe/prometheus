...
TARGET_PROFILES = {
    ...
    "launchdarkly": TargetProfile(
        ...
        api_patterns=[
            ...
            r"/contexts?", r"/segments?", r"/experiments?",
            r"/users?", r"/members?", r"/roles?",
        ],
        id_param_names=[
            "id", "projectId", "project_id", "envId", "env_id",
            "environmentId", "environment_id", "flagId", "flag_id",
            "contextId", "context_id", "memberId", "member_id",
            "orgId", "org_id", "key",
        ],
    ),
}
