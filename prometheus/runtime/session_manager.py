...
_pending_extra_bind_mounts: list[dict[str, str]] = []  # codeql[py/unused-global-variable] : read via `global` inside _set_extra_bind_mounts() and imported by docker_client._create_container()
