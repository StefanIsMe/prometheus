...
async def check_duplicate(
    ...
    try:
        ...
        _resolution = configure_sdk_model_defaults(settings)  # noqa: F841  — re-applies defaults; result is implicit  # codeql[py/unused-local-variable] : suppressed via the security dashboard triage
