...
from prometheus.telemetry._common import (
    SESSION_ID,
    base_props,
    get_version,
    is_first_run,
...
_SCARF_ENDPOINT = "https://prometheus.gateway.scarf.sh"
...
def _send(event: str, properties: dict[str, Any]) -> None:
    ...
    try:
        ...
        version = str(props.pop("prometheus_version", get_version()) or "unknown")
