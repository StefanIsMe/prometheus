#!/usr/bin/env bash
# setup_tor_proxy.sh — Verify Tor SOCKS5 proxy availability for Strix Docker sandbox scans
set -euo pipefail
...
echo ""
echo "Docker proxy URL for Strix containers:"
...
if [[ $FAIL -gt 0 ]]; then
    ...
    echo "STATUS: PASS — Tor proxy is ready for Strix."
    exit 0
fi
